...
const NewsTrends = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-2">News & Trends</h1>
      <p className="text-slate-400 mb-8">Curated updates explaining 'Why this matters' for your career.</p>

      <div className="space-y-6">
        {news.map((item) => (
          <div key={item.id} className="p-6 rounded-2xl bg-slate-800/40 border border-slate-700/50 hover:bg-slate-800/60 transition-all">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
              <div>
                ...
                <div className="bg-yellow-500/5 border-l-2 border-yellow-500/50 p-3 rounded-r-lg">
                  <p className="text-sm text-slate-300">
                    <span className="font-semibold text-yellow-500 uppercase text-xs block mb-1">Why this matters</span>
                    {item.why}
                  </p>
                </div>
              </div>
